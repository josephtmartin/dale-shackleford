...
export default function Research() {
  ...
  return (
    <div className='research-page'>
      ...
      <h2 className='thesis-title-grad' style={{ color: '#fafafa' }}>Graduate Thesis: Dante Networking and System Design at MTSU</h2>
      <h2 className='thesis-title-quote-grad' style={{ paddingBottom: '100px', color: '#fafafa' }}>
      ...
      <h2 className='abstract-title-grad' style={{ color: '#fafafa' }}>Abstract</h2>
      <p className='summary-para-grad'>
        Dante’s networked audio solutions have been growing in popularity for many years. The study of how Audio-over-IP is an increasingly important topic for
        audio engineers, but few understand the principles behind how transmission is accomplished using computer networking. This Final Project delves into the foundational concepts of
        how networks are used for this purpose and what Dante provides. It also provides case studies through a journal-style approach of how Dante technology can be utilized in remote
        sessions, livestream concerts, and larger inter-studio sessions. This leads to the end-product of a system design for Middle Tennessee State University to be able to implement
        Dante into its recording facilities.
      </p>

      <h2 className='thesis-title-undergrad' style={{ color: '#fafafa' }}>Middle Tennessee State University Undergraduate Honors Thesis:</h2>
      <h2 className='thesis-title-quote-undergrad' style={{ paddingBottom: '100px', color: '#fafafa' }}>
        "Undergraduate Honors Thesis for Middle Tennesee State University: Muskogean Tribal Influence on the Genre of Delta Blues"
      </h2>

      <h2 className='abstract-undergrad' style={{ color: '#fafafa' }}>Abstract</h2>
